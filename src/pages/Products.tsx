                      ...
                      >
                        ...
                        <div className={cn(
                          ...
                          <div className="mb-2 sm:mb-2.5">
                             <h3 className="text-[10px] sm:text-[11px] font-black text-slate-900 group-hover:text-brand-primary transition-colors mb-0.5 sm:mb-1 leading-[1.1] tracking-tight">
                               {product.title}
                             </h3>
